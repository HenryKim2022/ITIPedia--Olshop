                                ...
                                <div class="row align-items-end">
                                        ...
                                        <select name="deliveryman" class="form-control">
                                            @foreach ($users as $user)
                                                <option value="{{ $user->id }}"
                                                    {{ $deliveryman->id == $user->id ? 'selected' : '' }}>
                                                    {{ $user->name }}</option>
                                            @endforeach
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <select name="month" id="" class="form-control">
                                            <option {{ $payroll->month == 'November' ? 'selected' : '' }} value="November">
                                                {{ localize('November') }}</option>
                                            <option {{ $payroll->month == 'October' ? 'selected' : '' }} value="October">
                                                {{ localize('October') }}</option>
                                            <option {{ $payroll->month == 'September' ? 'selected' : '' }}
                                                value="September">{{ localize('September') }}</option>
                                            <option {{ $payroll->month == 'August' ? 'selected' : '' }} value="August">
                                                {{ localize('August') }}</option>
                                            <option {{ $payroll->month == 'July' ? 'selected' : '' }} value="July">
                                                {{ localize('July') }}</option>
                                            <option {{ $payroll->month == 'June' ? 'selected' : '' }} value="June">
                                                {{ localize('June') }}</option>
                                            <option {{ $payroll->month == 'May' ? 'selected' : '' }} value="May">
                                                {{ localize('May') }}</option>
                                            <option {{ $payroll->month == 'April' ? 'selected' : '' }} value="April">
                                                {{ localize('April') }}</option>
                                            <option {{ $payroll->month == 'March' ? 'selected' : '' }} value="March">
                                                {{ localize('March') }}</option>
                                            <option {{ $payroll->month == 'February' ? 'selected' : '' }} value="February">
                                                {{ localize('February') }}</option>
                                            <option {{ $payroll->month == 'January' ? 'selected' : '' }} value="January">
                                                {{ localize('January') }}</option>
                                            <option {{ $payroll->month == 'December' ? 'selected' : '' }} value="December">
                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="post">
                                ...
                                <div class="row" id="appear">
                                    <input type="hidden" name="deliveryman_id" id="deliveryman"
                                        value="{{ $deliveryman->id }}">
                                    <input type="hidden" name="month" id="monthname" value="{{ $payroll->month }}">
                                    <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="number" class="form-control" name="basic_sal"
                                                            step="any" value="{{ $deliveryman->salary }}"
                                                            readonly="">
                                                    </div>
                                    ...
                                    <div class="col-md-6 mt-3">
                                        <div class="card shadow-none mb-0">
                                            <div class="card-header d-flex justify-content-between">
                                                ...
                                                <button class="btn btn-danger btn-sm deduct"><i
                                                        data-feather="minus-circle"></i></button>
                                            </div>
                                            <div class="card-body" id="appearDeduct">
                                                @foreach ($payroll->deduct as $key => $deduct)
                                                    
                                                <div class="row remove align-items-end">
                                                    <div class="form-group col-md-5">
                                                        <label for="">{{ localize('title') }}</label>
                                                        <input type="text" class="form-control"
                                                            name="deduct[{{$key}}][title]" value="{{$deduct['title']}}">
                                                    </div>

                                                    <div class="form-group col-md-5">
                                                        <label for="">{{ localize('amount') }}</label>
                                                        <input type="text" class="form-control d_amount"
                                                            name="deduct[{{$key}}][amount]" value="{{$deduct['amount']}}">
                                                    </div>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" readonly=""
                                                        name="total_al" value="{{$payroll->total_allownce}}">
                                                </div>

                                                <div class="form-group">
                                                    <label for="">{{ localize('Total deductions') }}</label>
                                                    <input type="number" class="form-control" readonly=""
                                                        name="total_de" value="{{$payroll->total_deduction}}">
                                                </div>

                                                <div class="form-group">
                                                    <label for="">{{ localize('Net salary') }}</label>
                                                    <input type="number" class="form-control" readonly=""
                                                        name="net_sal" value="{{$payroll->total_salary}}">
                                                </div>


                                                <button type="submit"
                                                    class="btn btn-primary mt-4">{{ localize('Update') }}</button>
