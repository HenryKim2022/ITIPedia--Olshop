...
@section('title')
    {{ localize('Out For Delivery Orders') }} {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">{{ localize('Out For Delivery Orders') }}</h2>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table tt-footable border-top align-middle" data-use-parent-width="true">
                            <thead>
                                <tr>
                                    ...
                                    <th data-breakpoints="xs sm">{{ localize('Mark As Delivered') }}</th>
                                        ...
                                        <td>
                                            <div class="form-check form-switch">
                                                <input type="checkbox" class="form-check-input"
                                                    onchange="updateDeliveryStatusByDeliveryman('delivered', {{ $order->id }})">
                                            </div>
                                        </td>
